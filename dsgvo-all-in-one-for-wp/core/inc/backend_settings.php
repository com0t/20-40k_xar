	...
	if(isset($_POST["submit"])){ 
		...
		if ($privilegs == 1) {
			...
			if (isset($_POST["twitter_layer"])) {
				$twitter_layer = htmlentities(stripslashes($_POST["twitter_layer"]));
			} else {
				$twitter_layer = "";	
			}				
			...
			if ($showpolylangoptions == true or $language == "it") {
				...
				if (isset($_POST["twitter_layer_it"])) {
					$twitter_layer_it = htmlentities(stripslashes($_POST["twitter_layer_it"]));
				} else {
					$twitter_layer_it = "";	
				}					
			...
			if ($showpolylangoptions == true or $language == "it") {
				...
				if (isset($_POST["twitter_layer_it"])) {
					update_option("dsdvo_twitter_layer_it", htmlentities(stripslashes($_POST["twitter_layer_it"]), ENT_COMPAT, get_option('blog_charset')), false);	
				}					
				if (isset($_POST["vgwort_layer_it"])) {
			...
			if ($showpolylangoptions == true or $language == "en") {
				...
				if (isset($_POST["twitter_layer_en"])) {
					$twitter_layer_en = htmlentities(stripslashes($_POST["twitter_layer_en"]));
				} else {
					$twitter_layer_en = "";	
				}				
			...
			if ($showpolylangoptions == true or $language == "en") {
				...
				if (isset($_POST["twitter_layer_en"])) {
					update_option("dsdvo_twitter_layer_en", htmlentities(stripslashes($_POST["twitter_layer_en"]), ENT_COMPAT, get_option('blog_charset')), false);	
				}				
				if (isset($_POST["vgwort_layer_en"])) {
			...
			if (isset($_POST["twitter_layer"])) { update_option("dsdvo_twitter_layer", htmlentities(stripslashes($_POST["twitter_layer"]), ENT_COMPAT, get_option('blog_charset')), false);	}
			...
			$twitter_layer = html_entity_decode(get_option("dsdvo_twitter_layer"), ENT_COMPAT, get_option('blog_charset'));
			...
			$twitter_layer_en = html_entity_decode(get_option("dsdvo_twitter_layer_en"), ENT_COMPAT, get_option('blog_charset'));
			...
			$twitter_layer_it = html_entity_decode(get_option("dsdvo_twitter_layer_it"), ENT_COMPAT, get_option('blog_charset'));	
		...
		<span class="legalform_inforulecontaineryes">
					...
					<?php } ?>	
							...
							<?php if ($language == "de" or $showpolylangoptions == true) { ?>
								...
								?>									
								<?php wp_editor(html_entity_decode(stripslashes($twitter_layer_editor), ENT_COMPAT, get_option('blog_charset')), 'twitter_layer', array ('textarea_rows' => 60, 'media_buttons' => FALSE, 'teeny' => FALSE, 'tinymce' => TRUE, 'quicktags' => TRUE )); ?>
							<br />
							<?php } ?>					
							<?php if ($language == "en" or $showpolylangoptions == true) { ?>
							<?php if ($showpolylangoptions == true) { ?>
							...
							<?php } ?>	
								...
								?>									
								<?php wp_editor(html_entity_decode(stripslashes($twitter_layer_editor_en), ENT_COMPAT, get_option('blog_charset')), 'twitter_layer_en', array ('textarea_rows' => 60, 'media_buttons' => FALSE, 'teeny' => FALSE, 'tinymce' => TRUE, 'quicktags' => TRUE )); ?>
							<br />		
							<?php } ?>		
							<?php if ($language == "it" or $showpolylangoptions == true) { ?>
							<?php if ($showpolylangoptions == true) { ?>
							...
							<?php } ?>	
								...
								?>									
								<?php wp_editor(html_entity_decode(stripslashes($twitter_layer_editor_it), ENT_COMPAT, get_option('blog_charset')), 'twitter_layer_it', array ('textarea_rows' => 60, 'media_buttons' => FALSE, 'teeny' => FALSE, 'tinymce' => TRUE, 'quicktags' => TRUE )); ?>
							<br />		
							<?php } ?>
							</span>							
							<?php } ?>	
